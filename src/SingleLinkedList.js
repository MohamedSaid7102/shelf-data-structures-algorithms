...
var LinkedList = /** @class */ (function () {
  ...
  LinkedList.prototype.push = function (value) {
    ...
    if (this.isEmpty()) {
      ...
      while (iterator === null || iterator === void 0 ? void 0 : iterator.next)
        iterator =
          iterator === null || iterator === void 0 ? void 0 : iterator.next;
  ...
  LinkedList.prototype.insert = function (value, position) {
    ...
    if (position < 0 || position > this.length)
      throw new Error(
        'Out of bound, You only have '.concat(this.length, ' Nodes.')
      );
  ...
  LinkedList.prototype.pop = function () {
    ...
    try {
      ...
      if (this.length === 1) {
        var temp_1 = this.deepClone(
          (_a = this.head) === null || _a === void 0 ? void 0 : _a.value
        );
        this.head = null;
        this.length -= 1;
        return temp_1;
      ...
      if (this.length === 2) {
        var temp_2 = this.deepClone(
          (_c =
            (_b = this.head) === null || _b === void 0 ? void 0 : _b.next) ===
            null || _c === void 0
            ? void 0
            : _c.value
        );
      ...
      for (var i = 0; i < this.length - 2; i++) iterator = iterator.next;
  ...
  LinkedList.prototype.removeAt = function (index) {
    ...
    if (index > this.length - 1)
      throw new RangeError(
        "You can't delete node at index "
          .concat(index, ', ')
          .concat(
            this.length === 0
    ...
    var iterator = this.head;
    for (var i = 0; i < index - 1; i++) iterator = iterator.next;
    var temp = this.deepClone(
      iterator === null || iterator === void 0 ? void 0 : iterator.next
    );
  ...
  LinkedList.prototype.updateNodeWithIndex = function (index, newValue) {
    ...
    if (index > this.length - 1)
      throw new RangeError(
        "You can't update node at index "
          .concat(index, ', ')
          .concat(
            this.length === 0
              ? 'you do not have any nodes'
    ...
    var iterator = this.head;
    for (var i = 0; i < index; i++) iterator = iterator.next;
